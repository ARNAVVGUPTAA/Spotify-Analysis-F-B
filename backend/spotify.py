...
def submit():
    ...
    'user': {
        ...
        user_id: {
            	'tracks': top_tracks,
            	'artists': top_artists,
            	'openness': [request.form.get('openness1'), request.form.get('openness2')],
            	'conscientious': [request.form.get('conscentious1'), request.form.get('conscentious2')],
            	'extraversion': [request.form.get('extraversion1'), request.form.get('extraversion2')],
            	'agreeableness': [request.form.get('agreeableness1'), request.form.get('agreeableness2')],
            	'neuroticism': [request.form.get('neuroticism1'), request.form.get('neuroticism2')],
